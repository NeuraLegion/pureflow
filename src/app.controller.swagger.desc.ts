export const API_DESC_RENDER_REQUEST = `Template for rendering by doT. Expects plain text as request body`;
...
export const SWAGGER_DESC_SECRETS = `Secrets endpoint is disabled`;
